...
The finding rests on three measured obstacles (data from the repo's first month: 657 commits, 190 merged PRs (193 total), 228 issues — `git`/`gh`, 2026-05-21 → 2026-06-22):
